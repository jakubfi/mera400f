...
functions = {
    "start" : [ iobus.CPF, 0b00010000 ],
    "stop"  : [ iobus.CPF, 0b00000000 ],
    "mode1" : [ iobus.CPF, 0b00010001 ],
    "mode0" : [ iobus.CPF, 0b00000001 ],
    "clk1"  : [ iobus.CPF, 0b00010010 ],
    "clk0"  : [ iobus.CPF, 0b00000010 ],
    "stopn" : [ iobus.CPF, 0b00010011 ],
    "step"  : [ iobus.CPF, 0b00010100 ],
    "fetch" : [ iobus.CPF, 0b00010101 ],
    "store" : [ iobus.CPF, 0b00010110 ],
    "cycle" : [ iobus.CPF, 0b00010111 ],
    "load"  : [ iobus.CPF, 0b00011000 ],
    "bin"   : [ iobus.CPF, 0b00011001 ],
    "oprq"  : [ iobus.CPF, 0b00011010 ],
    "clear" : [ iobus.CPF, 0b00011011 ],
